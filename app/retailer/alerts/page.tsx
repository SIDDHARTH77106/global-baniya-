...
export default async function RetailerAlertsPage() {
  ...
  return (
    <DashboardLayout
      title="Retailer Low Stock Alerts"
      subtitle="Dedicated restocking queue for ProductVariant rows below the operational stock threshold."
      breadcrumbs={[{ label: 'Retailer', href: '/retailer/dashboard' }, { label: 'Low Stock Alerts' }]}
    >
      <DashboardShell
        icon={AlertTriangle}
        title="Critical Retailer Stock Alerts"
